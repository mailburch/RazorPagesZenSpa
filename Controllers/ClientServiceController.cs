...
namespace RazorPagesZenSpaCh7.Controllers
{
    public class ClientServiceController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ID,ClientID,ServicesID")] ClientService clientService)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,ClientID,ServicesID")] ClientService clientService)
        {
